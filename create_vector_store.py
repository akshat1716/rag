    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # Fallback: try to get collection size another way
                embedding_count = len(collection.get()['ids']) if hasattr(collection, 'get') else 0
        except Exception as e:
            print(f"\n⚠️  Warning: Could not verify embedding count: {e}")
            embedding_count = len(chunks)  # Assume all chunks were stored
